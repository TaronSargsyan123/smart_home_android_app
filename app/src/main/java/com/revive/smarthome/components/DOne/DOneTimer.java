...
public class DOneTimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_done_timer);

        createButton = findViewById(R.id.create_timer_d_one);
        selectTime = findViewById(R.id.select_time_d_one);
        checkBox = findViewById(R.id.check_box_frequency_d_one);
        frequency = findViewById(R.id.edit_text_timer_frequency_d_one);
        backButton = findViewById(R.id.back_timer_d_one);
        deviceList = findViewById(R.id.device_list_timer_d_one);
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(minutes != 0 && hours != 0){
                    ...
                    Toast.makeText(DOneTimer.this, "Please select time", Toast.LENGTH_SHORT).show();
                }
    ...
    public void startAlert(long millis, String command){
        ...
        String massage = command + "/" + inputData + "/DOne" + (slider.getValue()*100);
        Log.i("ARRBT", String.valueOf(slider.getValue()*100));

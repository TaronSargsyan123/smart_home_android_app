...
public class CROneTimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crone_timer);

        createButton = findViewById(R.id.create_time_c_r_one);
        selectTime = findViewById(R.id.select_time_c_r_one);
        checkBox = findViewById(R.id.check_box_frequency_c_r_one);
        frequency = findViewById(R.id.edit_text_timer_frequency_c_r_one);
        backButton = findViewById(R.id.back_timer_c_r_one);
        deviceList = findViewById(R.id.device_list_timer_c_r_one);
        spinner = findViewById(R.id.spinner_timer_c_r_one);
        textInputLayout = findViewById(R.id.enter_timer_frequency_c_r_one);
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(minutes != 0 && hours != 0){
                    ...
                    Toast.makeText(CROneTimer.this, "Please select time", Toast.LENGTH_SHORT).show();
                }
    ...
    public void startAlert(long millis, String command){
        ...
        String massage = command + "/" + inputData + "/CROne";
